class Scene(object):
    ...
    def add_paths(self, paths):
        self.paths.update(paths) # Create the scenes of the game 
...
getting into an escape pod. You're now running down the central corridor to the Weapons 
...
The Gothon bursts into laughter and rolls around on the ground. 
While its laughing you run up and use your copy of Nietzsche's notebooks 
