...
class DiningroomEG(Room):
	...
	def enter(self):
		...
		if choice == 'examine chairs':
			...
			print "Oh, it seems like someone has hidden a little flash drive between"
			print "the plates."
			print "The flash drive has been added to you inventory."
			video_pickup = True
			item_room = self.add_inventory('Flash drive', inp_room)
			return inp_room
...
class OfficeEG(Room):
	...
	def enter(self):
		...
		if choice == 'examine book case':
			...
			return inp_room
		elif choice == 'use flash drive with laptop' and 'Flash drive' in current_inventory:
			print "You use the laptop to see what is on the flash drive. "
...
class SaunaBasement(Room):
	...
	def enter(self):
		...
		if choice == 'examine sauna stove':
			...
			lid_pickup = True
			item_room = self.add_inventory('Bottle Lid', inp_room)
			return item_room
		elif choice == 'examine bench' and lid_pickup == False:
			print "You take a close look at the bench. "
	...
	def enter(self):
		...
		if flashlight_on == False:
			...
			if choice == 'examine shelves' and poison_pickup == False:
				...
				return inp_room
			elif 'use lid' in choice and 'Bottle Lid' in current_inventory:
...
class BedroomFirstFloor(Room):
	...
	def enter(self):
		...
		if choice == 'examine bed':
			...
			item_room = self.add_inventory('Cell phone', inp_room)
